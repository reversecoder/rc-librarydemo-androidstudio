...
public class SegmentedRadioGroup extends RadioGroup {
    ...
    private class LayoutSelector {
        ...
        private int child;
        private final int SELECTED_LAYOUT = R.drawable.segmented_radio_button_checked;
        private final int UNSELECTED_LAYOUT = R.drawable.segmented_radio_button_unchecked;
