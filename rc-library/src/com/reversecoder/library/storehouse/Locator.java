package com.reversecoder.library.storehouse;
...
/**
 * But for API 23 or above, you should check permission before using the
 * LocationManager.
 * 
...
public class Locator implements LocationListener {
	...
	static private final int TIME_INTERVAL = 100; // minimum time between
	                                              // updates in milliseconds
	static private final int DISTANCE_INTERVAL = 1; // minimum distance between
	                                                // updates in meters
	...
	public void onLocationChanged(Location location) {
		Log.d(LOG_TAG, "Location found : " + location.getLatitude() + ", " + location.getLongitude()
		        + (location.hasAccuracy() ? " : +- " + location.getAccuracy() + " meters" : ""));
		this.locationManager.removeUpdates(this);
