package com.reversecoder.library.typefacehelper;
 ...
 * {@link ViewGroup}. Supports String styling using
 * {@link SpannableString}
 * 
 * Applies typeface to all child views recursively.
 * 
 * For detailed information and guide:
 * https://github.com/jskierbi/android-typeface-helper
 */
public class TypefaceHelper {
	...
	/**
	 * Return spannable string with default typeface style (style:
	 * Typeface.NORMAL) see:
	 * http://stackoverflow.com/questions/8607707/how-to-set
	 * -a-custom-font-in-the-actionbar-title
	 * 
	 * @param context
	 *            to obtain string resource
	 * @param strResId
	 *            string resource id, content
	 * 
	 * @throws IllegalStateException
	 *             {@link #init(TypefaceCollection)} has not been called
	...
	public static SpannableString typeface(Context context, int strResId) {
		...
		return typeface(context.getString(strResId),
				sDefaultTypefaceCollection, Typeface.NORMAL);
	}

	/**
	 * Return spannable string with typeface in certain style see:
	 * http://stackoverflow
	 * .com/questions/8607707/how-to-set-a-custom-font-in-the-actionbar-title
	 * 
	 * @param context
	 *            to obtain string resource
	 * @param strResId
	 *            string resource id, content
	 * @param style
	 *            Typeface.NORMAL, Typeface.BOLD, Typeface.ITALIC or
	 *            Typeface.BOLD_ITALIC
	 * 
	 * @throws IllegalStateException
	 *             {@link #init(TypefaceCollection)} has not been calledC
	 * @return SpannableString that can be used in TextView.setText() method
	 */
	public static SpannableString typeface(Context context, int strResId,
			int style) {
		...
		return typeface(context.getString(strResId),
				sDefaultTypefaceCollection, style);
	}
	 ...
	 * http:/
	 * /stackoverflow.com/questions/8607707/how-to-set-a-custom-font-in-the
	 * -actionbar-title
	 * 
	 * @param sequence
	 *            content
	...
	public static SpannableString typeface(CharSequence sequence,
		...
		s.setSpan(new TypefaceSpan(typefaceCollection.getTypeface(style)), 0,
	 ...
	 *             {@link #init(TypefaceCollection)} has not been called
	 * @param activity
	 *            to typeface custom typefaces to
	 */
	public static void typeface(Activity activity) {
		...
		typeface(activity.findViewById(android.R.id.content),
				sDefaultTypefaceCollection);
	}
	 ...
	 * 
	 * @param view
	 *            view for which to typeface fonts
	 * @param typefaceCollection
	 *            Collection of typefaces
	 */
	 ...
	 *            typeface collection
	 */
	private static void applyTypeface(ViewGroup viewGroup,
			TypefaceCollection typefaceCollection) {
	 ...
	 *            typeface collection
	 */
	private static void applyForView(View view,
			TypefaceCollection typefaceCollection) {

		if (view instanceof TextView) {
			TextView textView = (TextView) view;
			Typeface oldTypeface = textView.getTypeface();
			final int style = oldTypeface == null ? Typeface.NORMAL
