...
import com.reversecoder.library.textview.CustomFontTextView;
import com.reversecoder.library.toolbar.ToolbarColorizeManager;
...
public class BaseActivity extends ParentActivity {
    ...
    public void setToolbar(boolean isToolbar) {
        if (isToolbar) {
            ...
            ToolbarColorizeManager.colorizeToolbar(BaseActivity.this, toolbar, android.R.color.white);
