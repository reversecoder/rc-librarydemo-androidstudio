 ...
 * StopWatchManager.getInstance(getActivity()).startStopWatch();
 * StopWatchManager.getInstance(getActivity()).getElapsedTimeString()
 *
...
public class StopWatchManager {
    ...
    private static StopWatchManager mStopWatchManager;
    ...
    public static class ElapsedTime {
         ...
         */
        public ElapsedTime(StopWatchManager stopwatch) {
    ...
    public static StopWatchManager getInstance(Context context) {
        if (mStopWatchManager == null) {
            mStopWatchManager = new StopWatchManager();
        }
        return mStopWatchManager;
    }
