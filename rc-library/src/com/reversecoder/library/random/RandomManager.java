package com.reversecoder.library.random;
...
public class RandomManager {
     ...
     * @param length
     * @return
     * @see RandomManager#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link RandomManager#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
