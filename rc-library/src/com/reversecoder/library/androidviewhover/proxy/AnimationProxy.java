package com.reversecoder.library.androidviewhover.proxy;
...
public class AnimationProxy implements Runnable {
    ...
    private AnimationProxy(View hoverView, View resId, Techniques technique, long duration, long delay, boolean invisibleWhenDelaying, Interpolator interpolator, Animator.AnimatorListener... listeners){
        if(hoverView == null)
...
//        View child = hoverView.findViewById(resId);
    ...
    public static AnimationProxy build(View hoverView, View resId, Techniques technique, long duration, long delay, boolean invisibleWhenDelaying, Interpolator interpolator, Animator.AnimatorListener... listeners){
